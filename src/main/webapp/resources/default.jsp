         ...
         <div class="modal-body">
           <form action="/insertBoard.do">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                   <label class="col-sm-3 control-label" for="inputAddress">상점소개</label>
                   <textarea name="editor" id="editor" style="width: 600px; height: 400px;"></textarea>
              </div>
            <div class="form-group">
...
<script src='http://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js'></script>
    ...
    <!-- <script  src="/resources/include/js/store.js"></script> -->
